...
Patient Name : {string.Join(" ", json_obj_patient["PatientTitle"].ToString(), json_obj_patient["PatientFName"].ToString(), json_obj_patient["PatientMName"].ToString(), json_obj_patient["PatientLName"].ToString())}".Trim();
                    }
                }
                catch (Exception ex)
                {
