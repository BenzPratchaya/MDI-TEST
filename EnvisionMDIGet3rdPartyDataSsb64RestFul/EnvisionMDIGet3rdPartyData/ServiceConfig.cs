...
namespace EnvisionMDIGet3rdPartyData
{
    public class ServiceConfig
    {
        ...
        public static string HisContextKey => IeServiceConfig.Open(key: $"{IeServiceConfig.ServiceName}.HisContextKey");
        public static string HisUrlPatient => IeServiceConfig.Open(key: $"{IeServiceConfig.ServiceName}.HisUrlPatient");
        public static string HisUrlPatientByVisitNo => IeServiceConfig.Open(key: $"{IeServiceConfig.ServiceName}.HisUrlPatientByVisitNo");
